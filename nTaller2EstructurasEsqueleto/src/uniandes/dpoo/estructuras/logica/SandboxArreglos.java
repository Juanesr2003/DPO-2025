...
public class SandboxArreglos
{
    ...
    {
    	return arregloEnteros.length == 0 ? new int[0] : arregloEnteros.clone();
    }
    ...
    {
    	return arregloCadenas.length == 0 ? new String[0] : arregloCadenas.clone();       
    }
    ...
    {
    	 if (arregloCadenas.length == 0) return 0;
    ...
    {
    	if (arregloEnteros.length == 0) return 0; // Si está vacío, devuelve 0
