...
public class CentralPersistencia
{
    ...
    public static IPersistenciaAerolinea getPersistenciaAerolinea( String tipoArchivo ) throws TipoInvalidoException
    {
        if (tipoArchivo.equals(PLAIN)) {
            PersistenciaAerolineaPlaintext persistenciaTxt = new PersistenciaAerolineaPlaintext();
            return persistenciaTxt;
        } 
        
        if (tipoArchivo.equals(JSON)) {
            IPersistenciaAerolineaJson persistenciaJson = new IPersistenciaAerolineaJson();
            return persistenciaJson;
        } 
        
        throw new TipoInvalidoException("Formato no soportado: " + tipoArchivo);
    }
