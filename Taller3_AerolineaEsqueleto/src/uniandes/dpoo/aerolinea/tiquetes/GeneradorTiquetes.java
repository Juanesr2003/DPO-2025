 ...
 */
public class GeneradorTiquetes extends Tiquete
{
    /**
    ...
    public GeneradorTiquetes(String codigo, Vuelo vuelo, Cliente clienteComprador, int tarifa) {
		super(codigo, vuelo, clienteComprador, tarifa);
	}
